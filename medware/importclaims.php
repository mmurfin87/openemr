...
$claimFields = array('Rec No', 'Claimnum', 'Qualifier', 'Idnum', 'Billtonum', 'Visitdate', 'Provider', 'Assistant', 'Assign', 'Destination', 'Secondaryecsflag', 'Status', 'Feeschedule', 'Employment', 'Autoaccident', 'Autoaccst', 'Otheraccident', 'Local1', 'Ins1', 'Ins2', 'Ins3', 'Dateofcurrent', 'Dateofillness', 'Noworkfrom', 'Noworkto', 'Refcode', 'Refno', 'Admitted', 'Discharged', 'Local2', 'Outsidelab', 'Labcharge', 'Dx1', 'Dx2', 'Dx3', 'Dx4', 'Mcaidresubmit', 'Mcaidorigref', 'Authorization', 'Facility', 'Facilitynum', 'Resp', 'Total', 'Instotal', 'Pttotal', 'Note', 'Hmo Flag', 'Requehcfa', 'Location', 'Lab.site', 'Lab.preopdx', 'Lab.postopdx', 'Lab.postopdate', 'Reportfilters.insclass', 'Reportfilters.carriertype', 'Reportfilters.ptclass', 'Reportfilters.prvclass', 'Ptagedate', 'Insagedate', 'Formtype', 'Epsdtcrc[0]', 'Epsdtcrc[1]', 'Epsdtcrc[2]', 'Dateentered', 'Timeentered', 'Whoentered', 'Datemodified', 'Timemodified', 'Whomodified', 'Recordinglocation', 'Long1', 'Long2', 'Decimal1', 'Decimal2', 'Byte1', 'Byte2', 'Supervising', 'String2', 'Visitmemo');
